static class GameMaster
{
    ...
    public static string Describe(Character character, Destination destination) => $"{GameMaster.Describe(character)} {GameMaster.Describe(TravelMethod.Walking)} {GameMaster.Describe(destination)}";
